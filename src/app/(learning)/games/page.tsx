...
import { Gamepad2, Star, Swords, Brain, Puzzle, Grid3X3, GripVertical, Zap, SpellCheck, Calculator, Palette, ShapesIcon } from 'lucide-react'
import Link from 'next/link'
import type { Game } from '@/types'

const typeIcons: Record<string, typeof Gamepad2> = {
  MEMORY: Brain,
  PUZZLE: Puzzle,
  SORTING: Grid3X3,
        ...
        >
          <motion.div variants={fadeInUp} className="text-center">
            ...
            <p className="text-lg text-white/60 font-nunito max-w-2xl mx-auto">
              Play games that make learning fun! Challenge yourself and earn rewards.
            </p>
          </motion.div>
          ...
          >
            {loading ? (
              ...
              <div className="col-span-full text-center py-20">
                ...
                <p className="text-white/40 font-nunito text-lg">No games available yet. Check back soon!</p>
              </div>
            ) : (
              games.map((game) => {
                const TypeIcon = typeIcons[game.type] || Gamepad2
                const diff = difficultyConfig[game.difficulty] || difficultyConfig.BEGINNER
                    ...
                    <motion.div variants={staggerItem}>
                      <Card variant="glass" className="h-full">
                        <div className="flex items-center gap-3 mb-3">
                          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-green to-green-light flex items-center justify-center shadow-lg">
